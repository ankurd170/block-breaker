...
//change written part of about and game won part to div in html
//music change---end previous music
        ...
        for (var r = 0; r < brickRowCount; r++) {
            ...
            if (b.status == 2) {
                ...
                if (x > b.x && x < b.x + brickWidth && y > b.y && y < b.y + brickHeight) {
                    ...
                    if(score == ((brickRowCount*brickColumnCount)-yellowbrick-blank)) {
...
function drawBricks() {
    ...
    for(var c=0; c<brickColumnCount; c++) {
        for(var r=0; r<brickRowCount; r++) {
            ...
            {   
                if(mariostatus==1)
                ctx.drawImage(blueblock,brickX,brickY);
                else
                ctx.drawImage(img4,brickX-10,brickY+10);
            }
            ...
            {   
                if(mariostatus==1)
                ctx.drawImage(yellowblock,brickX,brickY);
                else
                ctx.drawImage(img6,brickX,brickY+10);
            }
            ...
            {
                if(mariostatus==1)
                ctx.drawImage(mariomushroom1,brickX-5,brickY+11);
                else    
                ctx.drawImage(img7,brickX-5,brickY+11);    
            }
            ...
            {
                if(mariostatus==1)
                ctx.drawImage(mariomushroom2,brickX-5,brickY+5);
                else
                ctx.drawImage(img9,brickX,brickY+8);    
            }
            ...
            {
                if(mariostatus==1)
                ctx.drawImage(powerblock,brickX,brickY);    
                else
                ctx.drawImage(img8,brickX-3,brickY+3);    
            }
            else
            {
                if(mariostatus==1)
                ctx.drawImage(brownblock,brickX,brickY);    
                else
                ctx.drawImage(img1,brickX,brickY);
            }
