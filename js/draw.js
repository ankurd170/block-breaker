...
var img12 = document.getElementById("paddle1");
//all bricks used
...
var rad;
var mariostatus,stat,remb,remw,rems,scorenew,sound;
...
function keyPressHandler(e)
{
    ...
    var scr=sessionStorage.getItem("scorenow");
    var scr1=parseInt(scr);
    scorenew+=scr1;
        ...
        for (var r = 0; r < rows; r++) {
            ...
            if (b.status == 2) {
                if (x > b.x && x < b.x + bwd && y > b.y && y < b.y + bht) {
                    ...
                    {
                        if(rad==15)
                        new Audio("music/bigballbrownbluesmash.wav").play();    
                        else
                ...
                if (x > b.x && x < b.x + bwd && y > b.y && y < b.y + bht) {
                    ...
                    pwd = 170;
                    document.getElementById("paddle").style.width="170px";
                    b.status = 1;
                    remw=1000;
                }
            }
                    ...
                    if(score == ((rows*cols)-yellowbrick-blank)) {
                        ...
                        stat=1;
                            ...
                            else if(round==3)
                            {
                                ...
                                ctx.fillStyle = "#FFFFFF";
                                ctx.font = "23px bold Lucida Handwriting";
                                ctx.fillText("--BROWN MUSHROOM inceases size of ball. ",285, 300);
                                }
                                else
                                {
                                ctx.clearRect(0, 0, canvas.width, canvas.height);
...
function about()
{
    ...
    ctx.fillText("total score is:"+scorenew,365, 400);
    ctx.font="35px Bold Arial";
    ctx.fillStyle = "darkblue";
    ctx.fillText("PRESS ENTER TO RESTART.........",175, 460);
    ...
    if(pwd==170)
{
    if(remw>0)
    {remw--;
        ctx.drawImage(img12,px, canvas.height-59);
    }
    else
    {
        pwd=120;
...
function playnow(butid)
{
    ...
    rad=10;
    pwd = 120;
    document.getElementById("paddle").style.width="120px";
    ...
    for(var c=0; c<cols; c++) {
        ...
        for(var r=0; r<rows; r++) {
            ...
            console.log("round4 blanks:"+blank);
            }
...
function rules()
{
    ...
    ctx.fillStyle = "#FFFFFF";
    ctx.fillText("--BROWN MUSHROOM ball increases in size. ",170, 470);    
    }
    else
    {
    ...
    ctx.fillStyle = "#FFFFFF";
    ctx.fillText("--BLACK BRICKS ball speed increases. ",170, 530);
    }
...
function stopmusic(val)
{
    ...
    if(round==1)
    {
        ...
        else if(document.getElementById("mus").innerText=="STOP MUSIC")
    ...
    else if(val=="mus")
    {
        if(document.getElementById("mus").innerText=="START MUSIC")
        {
            ...
            if(mariostatus==1)
            var t=document.getElementById("marmain");
            else
            var t=document.getElementById("main");
...
function setup(butid) {
    ...
    else    
    {
        if(mariostatus==1)
        {
            ...
            var g=document.getElementById("marmain");
            g.pause();
